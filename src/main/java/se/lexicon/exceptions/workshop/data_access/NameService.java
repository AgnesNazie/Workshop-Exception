...
public class NameService {
     ...
     * @param name
     */
    public void addFemaleFirstName(String name) throws NoDuplicatedNameExceptions {
        if (femaleFirstNames.contains(name)) {
            throw new NoDuplicatedNameExceptions("The name '" + name + "' already exists in the list.");
        }
     ...
     * @param name
     */
    public void addMaleFirstName(String name) throws NoDuplicatedNameExceptions {
